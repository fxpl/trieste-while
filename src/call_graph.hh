...
namespace whilelang {
    ...
    class CallGraph {
      public:
        ...
        inline void add_edge(const Node &surronding_fun, const Node &fun_call);
        ...
        inline void log_functions_to_inline();
    ...
    inline void
    CallGraph::add_edge(const Node &surronding_fun, const Node &fun_call) {
        auto caller = get_identifier(surronding_fun);
    ...
    inline void CallGraph::log_functions_to_inline() {
